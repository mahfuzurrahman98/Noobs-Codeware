...
function go_further() {
    global $con, $id, $new_id, $tit, $prev_tit, $dif, $stat, $cons, $ipf, $opf, $note, $auth, $tcc, $tag, $arch;
    if ($stat == '') {
    ...
    if ($cons == '') {
        ...
        rename('../../uploads/admin/testcases/'.$id, '../../uploads/admin/testcases/'.$new_id);
