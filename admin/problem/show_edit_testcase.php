...
if (isset($_POST['updtst'])) {
    ...
    $upd_out = pera($_POST['tc_out2']);
    $pid2 = $_POST['pid2'];
    $tc_id2 = $_POST['tc_id2'];

    file_put_contents('../../uploads/admin/testcases/'.$pid2.'/input/'.$tc_id2, $upd_inp);
    file_put_contents('../../uploads/admin/testcases/'.$pid2.'/output/'.$tc_id2, $upd_out);
