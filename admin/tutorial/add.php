...
<body>
    ...
    <div class="contain">
        <div class="mt-5">
            <h2 class="text-center text-success">Add a tutorial</h2>
            <form class = "shadow-lg p-3 bg-light rounded my-3 mx-2" action="<?php $_SERVER['PHP_SELF'];?>" method="POST">
                <div class="row">
                    <div class="form-group col-12 col-md-4">
                        <label><b>Title:</b></label>
                        <input type="text" name="tut_tit" class="form-control" placeholder="Enter the title" required>
                    </div>
                    <div class="form-group col-12 col-md-4">
                    ...
                    <div class="form-group col-12 col-md-4">
                        ...
                        <input type="text" name="tut_auth" class="form-control" placeholder="Enter the author name, or username if registered" required>
                    </div>
                </div>
            ...
            if (isset($_POST['pub'])) {
                ...
                if (mysqli_num_rows($res) > 0) {
                    ...
                    $qry = "INSERT INTO Tutorial(Title, Content, Author, Category) VALUES('{$tut_tit}', '{$tut_content}', '{$tut_auth}', '{$tut_cat}');";
