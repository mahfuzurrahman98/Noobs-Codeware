    ...
    <div class="container-fluid">
        ...
        <div class="shadow bg-white rounded p-3">
            ...
            <form class="row p-2">
                ...
                <div class="col-12 form-group">
                    <label><b>Edit Authors:</b></label>
                    <input type="text" class="form-control" id="auth" value="<?php echo substr(substr($author, 1), 0, -1); ?>" placeholder="In case of multiple authors, separate using forward slash /">
                </div>
            </form>
        </div>
        ...
        <div class="my-5 text-center">
            ...
            <div class="mt-5 h5 alert alert-danger">In case this contest is unnecessary now or created for testing purposes, you can delete it.
                <a href="javascript:void(0)" class="ml-1 text-danger" data-toggle="modal" data-target="#dlt_cont">Delete Contest</a>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $("#set").click(function() {
                ...
                form_data.append('prev_title', "<?php echo $title; ?>");
