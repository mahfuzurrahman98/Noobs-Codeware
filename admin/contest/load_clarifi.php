...
$qry = "SELECT Cmnt_Id, _user, Problem, Ques, Replied FROM Clarifi_Comment WHERE Contest_Id = '{$contest}' AND Problem LIKE '%{$problem}%' AND _user != 'judge' ORDER BY Added_On ASC;";
