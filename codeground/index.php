...
<body>
                    ...
                    <div class="col-4 mx-auto">
                        <div class="form-group">
                            <select class="rounded-pill bg-dark form-control form-control-sm text-white" id="languages" class="languages" style="text-align-last: center;" onchange="changeLanguage()">
                                ...
                                <option <?php if ($prev_lang == 'Javascript') {echo 'selected';} ?> value="Javascript">Javascript</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-5 text-right">
                        <button class="mr-1 btn btn-primary btn-sm" data-toggle="tooltip" data-placement="right" title="Save to my device" id="save" onclick="saveCode()"><i class="far fa-save"></i></button>
                        <button class="mr-1 btn btn-light btn-sm" data-toggle="tooltip" data-placement="right" title="Toggle fullscreen" id="tfs" onclick="toggleFullscreen()"><i class="fas fa-expand"></i></button>
    ...
    <script src="../js/codeground_ide.js"></script>
