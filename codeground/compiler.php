...
if ($lang == 'C') {
    ...
    $code_file = 'noob.php';
    $compilation_command = 'timeout 10s php noob.php 2>comp_msg.txt';
    $execution_command = 'timeout 10s time -v php noob.php < input.txt 2>exec_msg.txt >output.txt';
    $binary_file = 'noob.php';
}

else if ($lang == 'Javascript') {
    $code_file = 'noob.js';
    $compilation_command = 'timeout 10s node noob.js 2>comp_msg.txt';
    $execution_command = 'timeout 10s time -v node noob.js < input.txt 2>exec_msg.txt >output.txt';
    $binary_file = 'noob.js';
}
