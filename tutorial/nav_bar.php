...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="nbcollapse">
        <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item ni px-2 px-lg-0 mx-lg-3">
                <a class="nav-link text-white" href="../contest"><i class="fas fa-trophy"></i> Compete</a>
            </li>
            <li class="nav-item ni px-2 px-lg-0 mx-lg-3">
                <a class="nav-link text-white" href="../tutorial"><i class="fas fa-book text-success"></i> Tutorial</a>
            </li>
            <li class="nav-item ni px-2 px-lg-0 mx-lg-3">
                <a class="nav-link text-white" href="../submission"><i class="fas fa-file-export"></i> Submission</a>
            </li>
            <li class="nav-item ni px-2 px-lg-0 mx-lg-3">
                <a class="nav-link text-white" href="../codeground"><i class="fas fa-cogs"></i> Compile</a>
            </li>
        </ul>
        <ul class="navbar-nav">
            <li class="nav-item">
