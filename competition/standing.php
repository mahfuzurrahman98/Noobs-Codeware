...
$qry = "SELECT Title, Problems, Scores, Start_Time, Finish_Time FROM User_Contest WHERE Id = '{$id}';";
...
$qry = "SELECT Username, Problem, Verdict, TIMESTAMPDIFF(SECOND, Start_Time, Sub_Time) AS subtym FROM User_Contest JOIN User_Contest_Submission WHERE Id = Contest_Id AND Contest_Id = '{$id}' AND Verdict != 'Compilation Error' ORDER BY Sub_Time ASC;";
$res = mysqli_query($con, $qry);
