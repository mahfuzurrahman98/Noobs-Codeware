        ...
        <div class="Filter">
            <div class="row p-2">
                <div class="col-3 form-group">
                    ...
                    <select id="pnum" class="form-control form-control-sm" onchange="filterData()">
                        <?php for ($i = 0; $i < count($probs); $i++) { ?>
                            <option value="<?php echo $prb_cnt; ?>"> <?php echo $prb_cnt; $prb_cnt++;?></option>
                        <?php } ?>
