...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark fub">
    ...
    <div class="collapse navbar-collapse" id="nbcollapse">
        <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item ni px-2 px-lg-0 mx-lg-3">
                <a class="nav-link text-white" href="../contest"><i class="fas fa-trophy text-success"></i> Contest</a>
            </li>
            <li class="nav-item ni px-2 px-lg-0 mx-lg-3">
