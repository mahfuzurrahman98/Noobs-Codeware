...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="mx-lg-5 mb-5">
            <table class="table table-success table-hover rounded" style="cursor: pointer; cursor: hand;">
                <tbody>
                <?php
                $qry = "SELECT Cmnt_Id, Ques FROM User_Clarifi_Comment WHERE Contest_Id = '{$id}' AND _user = 'judge' ORDER BY Added_On ASC;";
    ...
    if (isset($_POST['general_announce_submit'])) {
        ...
        $qry = "INSERT INTO User_Clarifi_Comment(Contest_Id, Ques) VALUES('{$id}', '{$announce}');";
